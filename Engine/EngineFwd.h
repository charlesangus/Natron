...
typedef std::shared_ptr<DeepImageCacheEntry> DeepImageCacheEntryPtr;
typedef std::shared_ptr<DeepImageParams> DeepImageParamsPtr;
...
typedef std::shared_ptr<ImageLayerDesc> ImageLayerDescPtr;
typedef std::shared_ptr<KnobBool> KnobBoolPtr;
typedef std::shared_ptr<KnobButton> KnobButtonPtr;
typedef std::shared_ptr<KnobChannelSelect> KnobChannelSelectPtr;
typedef std::shared_ptr<KnobChannelSet> KnobChannelSetPtr;
...
typedef std::shared_ptr<KnobLayerSelect> KnobLayerSelectPtr;
...
typedef std::shared_ptr<KnobShuffleMap> KnobShuffleMapPtr;
...
typedef std::shared_ptr<SampleTable> SampleTablePtr;
...
typedef std::weak_ptr<DeepImage> DeepImageWPtr;
...
typedef std::weak_ptr<KnobChannelSelect> KnobChannelSelectWPtr;
typedef std::weak_ptr<KnobChannelSet> KnobChannelSetWPtr;
...
typedef std::weak_ptr<KnobLayerSelect> KnobLayerSelectWPtr;
...
typedef std::weak_ptr<KnobShuffleMap> KnobShuffleMapWPtr;
