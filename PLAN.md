...
status: running
current: M13.P3.T1
pm_heartbeat: 2026-09-02T11:12:00-04:00
...
| M13 | Build the full upstream OFX plugin set | doing | [M13-full-ofx-plugin-set.md](PLAN/MILESTONES/M13-full-ofx-plugin-set.md) |
