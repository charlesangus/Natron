...
- [x] M58.P1.T1 — Add a committed three-layer flat EXR fixture and its generator
  ...
  - size: S
- [x] M58.P1.T2 — Add a gtest that toggles All Layers between two renders and checks every layer's pixels
  ...
  - size: M
- [x] M58.P1.T3 — Fold the Read/Write container's knob age into the embedded node's hash and recompute it with the container
